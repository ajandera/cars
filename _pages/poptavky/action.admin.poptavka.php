...
if(prava('admin-poptavky',true))
{
	...
	'ss'=>'<div class="row"><div class="col-sm-6">'.createInputBlockStart(($corePage->new?l('Nová poptávka'):l('Úprava poptávky'))),
		...
		'instacover_photo_finished'=>createInputCheckbox('instacover_photo_finished',0,$_POST['stav_photoscompleted'],'Instacover fotky nahrané','form-group',false, false, ''),
		'source_savedby'=>createInputHidden('source_savedby',(!$corePage->new?$_POST['source_savedby']:'manual')),
		'instacover_refresh' => createInputButton("instacover_refresh","Vygenerovat novou session z Instacover","","form-group btn btn-primary btn-block","",false,false,''),
		'instacover_session_id' => createInputText("instacover_session",$_POST['instacover_session_id'],l("Instacover session"),"form-group",false,"form-control form-control-lg rounded-0",false,false,''),
