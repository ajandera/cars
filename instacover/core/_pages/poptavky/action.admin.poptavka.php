...
if(prava('admin-poptavky',true))
{
	...
	'ss'=>'<div class="row"><div class="col-sm-6">'.createInputBlockStart(($corePage->new?l('Nová poptávka'):l('Úprava poptávky'))),
		...
		'marketingAdd'=>'',
		'marketing'=>createInputCheckbox('marketing',1,$_POST['marketing'],'Souhlas pro marketing','form-group',false),
	...
	else
	{
		if(!$corePage->new)
		{
			$corePage->dataForm['marketing'] = createInputHidden('marketing',0);
		}
	}
