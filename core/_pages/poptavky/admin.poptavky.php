...
else
{
	...
	if (isset($_GET["instacover_finished"]) && !empty($_GET["instacover_finished"]))
	{
		$addWHEREpay .= " AND stav_photoscompleted = ". clearUnsafeChars($_GET["instacover_finished"]) ."";
		echo createInputCheckbox("instacover_finished",1,$_GET["instacover_finished"],'Foto dokončené',"checkbox",false,"form-control");
	}else{
		echo createInputCheckbox("instacover_finished",1,false,'Foto dokončené',"checkbox",false,"form-control");
	}
